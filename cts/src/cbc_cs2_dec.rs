...
#[derive(Clone)]
pub struct CbcCs2Dec<C: BlockDecrypt> {
    cipher: C,
    iv: Block<C>,
}

impl<C: BlockDecrypt> InnerUser for CbcCs2Dec<C> {
    type Inner = C;
}

impl<C: BlockDecrypt> IvSizeUser for CbcCs2Dec<C> {
    type IvSize = C::BlockSize;
}

impl<C: BlockDecrypt> InnerIvInit for CbcCs2Dec<C> {
...
impl<C: BlockDecrypt> Decrypt for CbcCs2Dec<C> {
